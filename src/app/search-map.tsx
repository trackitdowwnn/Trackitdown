/**
 * WHAT:  Route for the map-search surface — the full-screen map + list of
 *        active posts. Pushed from the home feed's search pill, Map pill,
 *        and "See all →" links with optional { area?, query? } params.
